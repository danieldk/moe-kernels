...
bool call_marlin_moe_kernel_ku4b8(
  ...
  GPTQ_CALL_IF_MOE(moe_kernels::kU4B8, 16, 4, 256)
  GPTQ_CALL_IF_MOE(moe_kernels::kU4B8, 8, 8, 256)
  GPTQ_CALL_IF_MOE(moe_kernels::kU4B8, 8, 4, 128)
  GPTQ_CALL_IF_MOE(moe_kernels::kU4B8, 4, 8, 128)
  else {
    return false;
  }
  return true;
