...
bool call_marlin_moe_kernel_ku4(
  ...
  AWQ_CALL_IF_MOE(moe_kernels::kU4, 16, 4, 256)
  AWQ_CALL_IF_MOE(moe_kernels::kU4, 8, 8, 256)
  AWQ_CALL_IF_MOE(moe_kernels::kU4, 8, 4, 128)
  AWQ_CALL_IF_MOE(moe_kernels::kU4, 4, 8, 128)
  else {
    return false;
  }
  return true;
